...
Prioritized future work is tracked in **[`ROADMAP.md`](./ROADMAP.md)**. Items 1–7 are done; next is **#8** (store weigh-in weight as a hash / String with migration). See **[`AUTH.md`](./AUTH.md)** for sign-in and creating users.
